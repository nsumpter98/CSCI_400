...
<!--
Web Forms: Redisplay the Web form - Sticky Forms Example

The code will validate user's input: 
All three fields are required
Only four majors are accepted. They must be stored in an array and your code will valid a major case-insensitive
-->
